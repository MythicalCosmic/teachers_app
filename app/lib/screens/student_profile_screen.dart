  ...
  Widget build(BuildContext context) {
    ...
    return SfScaffold(
      ...
      top: SfNavBar(
        ...
        actions: const [Icon(SfIcons.chat), SizedBox(width: 12), Icon(SfIcons.more)],
      ),
      body: ListView(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('13 ta',
                    style: SfType.ui(size: 11, weight: FontWeight.w600, color: c.primary)),
            ...
            child: Column(
              children: [
                for (final r in const [
                  ('19 May · 09:42', 'Yulduz karta', 'Mustaqil yechim · 3-misol', 'up'),
                  ('17 May · 10:18', 'Aktivlik', 'Sinfdoshlariga yordam berdi', 'up'),
                  ('12 May · 11:30', 'Yulduz karta', 'Daftar — namunaviy', 'up'),
                  ('8 May · 09:05', 'Ogohlantirish', 'Darsda telefon bilan band', 'down'),
                  ('5 May · 14:22', 'Yulduz karta', 'Olimpiada · 2-bosqich', 'up'),
                ])
                    ...
                    child: SfSurfaceCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(g.$1,
                              style: SfType.ui(
                                  size: 13, weight: FontWeight.w600, color: c.ink, height: 1.2)),
                          const SizedBox(height: 2),
                          Text(g.$2, style: SfType.ui(size: 10, color: c.muted)),
                          const SizedBox(height: 4),
                          Text(g.$3, style: SfType.mono(size: 11, color: c.primary)),
                        ],
                      ),
                    ),
                  ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 40,
                  decoration: BoxDecoration(
                      color: c.successSoft, borderRadius: BorderRadius.circular(12)),
...
class _CardRow extends StatelessWidget {
  ...
  final String reason;
  final String kind;
  const _CardRow({required this.date, required this.type, required this.reason, required this.kind});
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: isUp ? const Color(0xFFC49A3A) : const Color(0xFFA14026)),
              borderRadius: BorderRadius.circular(6),
            ),
            alignment: Alignment.center,
            child: SfStar(size: 12, color: isUp ? const Color(0xFF7A4F0E) : const Color(0xFF5C1A0C)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('"$reason"',
                    style: SfType.display(
                        size: 11, color: c.muted, style: FontStyle.italic)),
              ],
            ),
          ),
